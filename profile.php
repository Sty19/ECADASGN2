...
<div class="container">
        <form name="register" action="editProfile.php" method="post" onsubmit="return validateForm()">
            ...
            <div class="mb-3 row">
                ...
                <div>
                    <input class="form-control" name="birthdate" id="birthdate" type="date" value="<?= htmlspecialchars($birthdate) ?>" />
                </div>
            </div>
            <div class="mb-3 row">
                <label class="col-form-label" for="address">Address:</label>
                <div>
                    <textarea class="form-control" name="address" id="address" cols="25" rows="4"><?= htmlspecialchars($address) ?></textarea>
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div>
                    <input class="form-control" name="password" id="password" type="password" required value="<?= htmlspecialchars($password) ?>" /> 
                    <span class="required">(required)</span>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div>
                    <input class="form-control" name="pwdquestion" id="pwdquestion" type="text" required value="<?= htmlspecialchars($pwdquestion) ?>" /> 
                    <span class="required">(required)</span>
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div>
                    <input class="form-control" name="pwdanswer" id="pwdanswer" type="text" required value="<?= htmlspecialchars($pwdanswer) ?>" /> 
                    <span class="required">(required)</span>
                </div>
            </div>
